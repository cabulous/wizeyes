  ...
  return (
    <div className={styles.main}>
      <div className={styles.wrapper}>
        ...
        <p>
          <i>Last Updated: May 29, 2024</i>
        </p>
        <h3 className={styles.title}>Introduction</h3>
        <p>
          Welcome to FamilyAssets. This Privacy Policy explains how we handle
          your personal information and data. The policy is applicable to the
          FamilyAssets app available on iOS devices.
        </p>
        ...
        <p>
          All data entered into FamilyAssets is stored locally on your device
