...
export default function BloodTestTrackerPage() {
  return (
    <div className={styles.main}>
      <div className={styles.wrapper}>
        ...
        <ul>
          <li>
            Private and Flexible Storage: Securely store your health data on
            your device and personal iCloud. Enjoy privacy and easy access
            across your Apple devices without sacrificing security.
          </li>
          <li>
            Efficient Report Management: Effortlessly view, organize, and track
            your health data over time with a few simple taps.
          </li>
        </ul>

        <h2 className={styles.title}>Privacy Policy</h2>
        <p>
          <i>Last Updated: Jan. 3, 2024</i>
        </p>
