...
export default function TaxSavingTrackerPage() {
  return (
    <div className={styles.main}>
      <div className={styles.wrapper}>
        <h1>TaxSavingTracker</h1>
        ...
        <p>
          <i>Last Updated: June 18, 2025</i>
        </p>
        <h3 className={styles.title}>Introduction</h3>
        <p>
          Welcome to TaxSavingTracker. This Privacy Policy explains how we
          handle your personal information and data. The policy is applicable to
          the TaxSavingTracker app available on iOS devices.
        </p>
        ...
        <p>
          All data entered into TaxSavingTracker is stored locally on your
