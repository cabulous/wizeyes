...
export default function SoloBooksPage() {
  return (
    <div className={styles.main}>
      <div className={styles.wrapper}>
        ...
        <p>
          <i>Last Updated: May. 8, 2024</i>
        </p>
        <h3 className={styles.title}>Introduction</h3>
        <p>
          Welcome to SoloBooks. This Privacy Policy explains how we handle your
          personal information and data. The policy is applicable to the
          SoloBooks app available on iOS devices.
        </p>
        ...
        <p>
          All data entered into SoloBooks is stored locally on your device and
          can be synced with your iCloud account. We do not have access to any
          of the data you store in the app, and we do not store or transmit your
